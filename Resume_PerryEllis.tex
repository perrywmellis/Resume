...
\underline{P.W. Ellis}, J. Nambisan, A. Fern\'{a}ndez-Nieves, \emph{Coherence-enhanced diffusion filtering applied to partially-\\ \hspace*{15pt} ordered fluids}, (In preparation)\\
...
\hspace*{10pt}$\bullet$ Develop a microfluidic platform to screen human embryonic stem cell cysts for homogeneity\\
\hspace*{10pt}$\bullet$ Build a human embryonic stem cell line to overexpress the molecule BMP4 when triggered by a chemical\\ \hspace*{15pt} signal\\
\hspace*{10pt}$\bullet$ Combine the BMP4 cell line and the microfluidic platform to quantitatively study differentiation and\\ \hspace*{15pt} gastrulation in human embryonic stem cell cysts. \\

{\bf Postdoctoral Fellow}, Harvard University, Cambridge, MA \hfill Fall 2019 -- Present\\
%\hspace*{10pt}$\bullet$ Investigate an active nematic material confined to a toroidal surface\\
\hspace*{10pt}$\bullet$ Develop a microfluidic platform to screen bacterial phenotypes for pathogenicity\\
\hspace*{10pt}$\bullet$ Develop a test for bacterial adhesion to human extracellular matrix compatible with droplet microfluidics\\
\hspace*{10pt}$\bullet$ Develop a test for bacterial immune avoidance compatible with droplet microfluidics\\
